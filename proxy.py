...
def device():
    ...
    nb.ipam.ip-addresses.update([{'id': primary_ip6.id, 'vrf': 1, 'assigned_object_type': 'dcim.interface', 'assigned_object_id': int_id}])
...
def cable():
    ...
    nb.ipam.ip-addresses.update([{'id': ip_a_side.id, 'vrf': 1, 'assigned_object_type': 'dcim.interface', 'assigned_object_id': a_interface_id}])
    nb.ipam.ip-addresses.update([{'id': ip_b_side.id, 'vrf': 1, 'assigned_object_type': 'dcim.interface', 'assigned_object_id': b_interface_id}])
